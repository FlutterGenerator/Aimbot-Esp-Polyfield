...
void LogShaders() {
    ...
    if (dlsym_error) {
        ...
        MSHookFunction(reinterpret_cast<void *>(p_glGetUniformLocation),
                       reinterpret_cast<void *>(new_glGetUniformLocation),
...
void Wallhack() {
    ...
    if (dlsym_error) {
        ...
        MSHookFunction(reinterpret_cast<void *>(p_glDrawElements),
                       reinterpret_cast<void *>(new_glDrawElements),
